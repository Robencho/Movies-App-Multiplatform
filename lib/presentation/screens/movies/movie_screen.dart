        ...
        slivers: [
          ...
          SliverList(
              delegate: SliverChildBuilderDelegate(
                  (context, index) => _CustomMovieDescription(movie: movie),
                  childCount: 1))
        ],
      ),
    );
...
class _CustomMovieDescription extends StatelessWidget {
  final Movie movie;
  const _CustomMovieDescription({required this.movie});
